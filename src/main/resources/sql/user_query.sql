...
SELECT *
FROM user_info
WHERE USER_EMAIL = "joonsoung93@naver.com";
UPDATE user_info SET USER_PASS = "zz", USER_NAME="tt",USER_GENDER="tt",USER_AGE=30,USER_PHONE="tt", USER_NICKNAME="tt", USER_REGE = SYSDATE(),USER_AUTHORITY=0,USER_BIRTH= SYSDATE()
WHERE user_num = 1;
